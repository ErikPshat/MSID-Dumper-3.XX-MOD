 ...
 { 
         ...
         color(green);
         printf("Эта программа создаст в корне карты памяти файл msid.bin\n");
         printf("И ещё все 3 секции по 512 байт атрибутов в файл attr.bin\n\n");
         ...
         sceIoClose(fd);
         printf("запись в файлы attr.bin, msid.bin - OK!\n\n");
